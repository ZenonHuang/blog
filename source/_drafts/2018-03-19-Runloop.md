...
1.通过 runloop 的 modeName 查找当前 mode，在该过程中，如果找到了，则会直接返回，否则直接为 null.
2.如果 当前 mode 为空，整个函数会返回 CFRunLoopRunFinished
...
kCFRunLoopRunHandledSource 意思，是执行 source . 然后 did 一直等于 false ，不知道在哪里才会更改？
